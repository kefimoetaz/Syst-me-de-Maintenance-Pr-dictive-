...
export default function Signup() {
  ...
  const validateForm = () => {
    if (!formData.full_name.trim()) { setError('Le nom complet est requis'); return false; }
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel - same purple gradient as Login */}
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="mb-8">
              ...
              <p className="text-gray-600">Commencez à surveiller vos machines</p>
            </div>
            ...
            <p className="mt-6 text-center text-sm text-gray-600">
              ...
              <Link to="/login" className="text-[#5B3DF5] font-semibold hover:underline">
                Se connecter
              </Link>
            </p>
          </div>
