...
function Login() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel - Purple Gradient matching Dashboard & Landing */}
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">Monitoring continu de vos machines avec alertes instantanées</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">Prédictions intelligentes des pannes avant qu'elles surviennent</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">Analytics complets et tableaux de bord personnalisables</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex justify-end">
                <Link to="/forgot-password" className="text-sm text-[#5B3DF5] hover:underline font-medium">
                  Mot de passe oublié ?
                </Link>
              </div>
            ...
            <p className="mt-6 text-center text-sm text-gray-600">
              ...
              <Link to="/signup" className="text-[#5B3DF5] font-semibold hover:underline">
                Créer un compte
              </Link>
            </p>
